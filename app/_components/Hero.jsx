    ...
    <div className="mx-auto max-w-screen-xl px-4 py-32 lg:flex">
      <div className="mx-auto max-w-xl text-center">
        ...
        <p className="mt-4 sm:text-xl/relaxed">
          ...
          numquam ea! Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quia, harum?
        </p>
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-4">
          ...
          <a
            className="block w-full rounded px-12 py-3 text-sm font-medium text-text-primary shadow hover:text-blue-700 focus:outline-none focus:ring active:text-red-500 sm:w-auto"
            href="/about"
          >
            Learn More
          </a>
